...
//#START SOLUTION
        // Erstellen des ersten Vektors mit zufälligen x- und y-Werten im Bereich [-25, 25[
        ...
        // Skalarprodukt zwischen v1 und der X-Achse berechnen
        double scalarProduct = Vec2D.XAxis.dot(v1Normalized);
        // Winkel (in Radianten) bestimmen
        double w1 = Math.acos(scalarProduct);

        // Erstellen des zweiten Vektors mit zufälligen x- und y-Werten im Bereich [-25, 25[
