...
class Vec2D {
     ...
     */
    public static final Vec2D NegativeXAxis = new Vec2D(-1, 0);
    /**
     * A Vector pointing in the negative Y-Direction
     */
    public static final Vec2D NegativeYAxis = new Vec2D(0, -1);
    ...
    /**
     * Divides the components of this vector by a scalar Value and returns the result as a new Vector.
     * 
     ...
     */
    final public double dot(final Vec2D v) {
        return x * v.x + y * v.y ;
    }
