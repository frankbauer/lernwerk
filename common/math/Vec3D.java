...
class Vec3D {
     ...
     */
    public static final Vec3D NegativeXAxis = new Vec3D(-1, 0, 0);
    /**
     * A Vector pointing in the negative Y-Direction
     */
    public static final Vec3D NegativeYAxis = new Vec3D(0, -1, 0);
    /**
     * A Vector pointing in the negative Z-Direction
     */
    public static final Vec3D NegativeZAxis = new Vec3D(0, 0, -1);
    ...
    final public Vec3D createPerpendicular() {
        ...
        else if (equals(Vec3D.NegativeYAxis))
            return XAxis;
